  ...
  <MainLayout>
    ...
    <section class="home-hero">
      ...
      <div class="hero-content container">
        <h1>Flota ejecutiva</h1>
        <p>Aeronaves de lujo para viajes de negocios y privados</p>
      </div>
    </section>
    ...
    <section class="fleet-section">
      <div class="container">
        <div class="fleet-intro">
          <span class="fleet-kicker">Colección de aviación privada</span>
          <h2>Aeronaves seleccionadas para viajes ejecutivos, flexibilidad y confort</h2>
          <p>
            Explora nuestra flota activa y revisa disponibilidad de un vistazo
            antes de solicitar una cotización personalizada.
          </p>
        </div>
            ...
            <div class="fleet-content">
              ...
              <div class="fleet-info">
                ...
                >
                  {{
                    item.disponible
                      ? "Disponible para charter"
                      : "No disponible por ahora"
                  }}
                </span>
              </div>

              <p class="price">${{ item.precio_renta_usd }} / hora</p>
...
.btn-quote {
  ...
  text-transform: uppercase;
  cursor: pointer;
  box-shadow: 0 20px 36px rgba(201, 151, 47, 0.28);
  transition: all 0.3s ease;
}

.btn-quote:hover {
  background: linear-gradient(135deg, #ffd989, #d9a948);
  transform: translateY(-2px);
  box-shadow: 0 24px 40px rgba(201, 151, 47, 0.34);
}
